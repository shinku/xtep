...
var BackgroundImage = function () {
    ...
    BackgroundImage.prototype.resize = function resize() {
        this.uniforms.resolution.value.set(640, 640);
    };
...
var renderBack1 = new THREE.WebGLRenderTarget(640, 640);
var scene = new THREE.Scene();
var sceneBack = new THREE.Scene();
var camera = new THREE.OrthographicCamera(-1, 1, 1, -1, 0, 1);
var cameraBack = new THREE.PerspectiveCamera(45, 640 / 640, 1, 1000);
console.log(2);
...
var resizeWindow = function resizeWindow() {
    canvas.width = 640;
    canvas.height = 640;
    cameraBack.aspect = 640 / 640;
    cameraBack.updateProjectionMatrix();
    bgImg.resize();
    postEffect.resize();
    renderBack1.setSize(640, 640);
...
var brokenInit = function brokenInit(imgurl) {
    renderer.setSize(640, 640);
    renderer.setClearColor(0x000000, 0.0);
    cameraBack.position.set(0, 0, 100);
    cameraBack.lookAt(new THREE.Vector3());
    imgurl=imgurl || "images/osaka01.jpg";
    bgImg.init(imgurl, function () {
